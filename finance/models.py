...
from corecode.models import StudentClass, AcademicSession, AcademicTerm,ExpenseCategory
from main.models import Student

class Invoice(models.Model):
  student = models.ForeignKey(Student, on_delete=models.CASCADE)
  year = models.ForeignKey(AcademicSession, on_delete=models.CASCADE)
  month = models.ForeignKey(AcademicTerm, on_delete=models.CASCADE)
