...
from .models import SiteConfig, AcademicSession, AcademicTerm, StudentClass, Subject,ExpenseCategory
from .forms import SiteConfigForm,ExpenseCategoryForm, AcademicTermForm, AcademicSessionForm, StudentClassForm, SubjectForm, CurrentSessionForm
...
class SessionCreateView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
  ...
  success_url = reverse_lazy('corecode:sessions')
...
class TermCreateView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
  ...
  template_name = 'corecode/mgt_form.html'
  success_url = reverse_lazy('corecode:terms')
...
class ExpenseCategoryListView(SuccessMessageMixin, ListView):
  model = ExpenseCategory
  template_name = 'corecode/expense_category_list.html'
...
class ExpenseCategoryDeleteView(DeleteView):
  ...
  def delete(self, request, *args, **kwargs):
      ...
      print(obj.name)
      messages.success(self.request, self.success_message.format(obj.name))
      return super(ExpenseCategoryDeleteView, self).delete(request, *args, **kwargs)
